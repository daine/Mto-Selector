	  ...
	  $.fn.mtoSelector = function(options) {
		  ...
		  elements.each(function(index){
			  ...
			  if($(this).attr('selected')){
				  monthStr = '<div class="ui-clickable selected " value="'+$(this).val()+'">'+insidehtml+'</div>';
			  }else{
				  monthStr = '<div class="ui-clickable" value="'+$(this).val()+'" style="display: none">'+insidehtml+'</div>';
			  }
		  ...
		  if(settings['dropdown']){
			  this.parent().find('.ui-clickable').click(function(){
				  //console.log(this);
				  hide = $(this).parent().parent().attr('option');
				  //console.log($(this).parent().parent());
				  if(hide == 'hidden'){
					  $(this).parent().find('.ui-clickable').css('display', 'block');
					  $(this).parent().parent().attr('option', 'visible');
					  $(this).removeClass('selected');
				  }else{
					  $(this).parent().parent().attr('option', 'hidden');
					  $(this).parent().find('.ui-clickable').css('display', 'none');
